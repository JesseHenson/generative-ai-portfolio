...
from llama_index.legacy import LLMPredictor, ServiceContext
...
python_lottie = load_lottieurl("https://lottie.host/a88e27a8-251c-4e1e-8311-92b26ee74df9/vbVbIZmt5i.json")
aws_lottie = load_lottieurl("https://lottie.host/1ac8922c-0da6-46ed-9f17-08afb6ae5e01/omwxHsGs0M.json")
...
with st.container():
    ...
    with col2:
        "🦜️🔗"
    with col3:
        st_lottie(aws_lottie,height=70,width=70, key="mysql", speed=2.5)
    with col4:
...
#     # In the first column (col1) 
    with col1: 
        ...
        nest_col1, nest_col2 = st.columns([.5,.5])
        with nest_col1:
